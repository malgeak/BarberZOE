<?php
	...
	$resultado = mysqli_query($conexion, $query) or die("Error al crear negocio");

	$query = "INSERT INTO negocio VALUES ('$negocio') ON CONFLICT DO NOTHING";
	$resultado = mysqli_query($conexion, $query) or die("Error al insertar nombre del negocio");
	...
	$resultado = mysqli_query($conexion, $query) or die("Error al crear inventario");
	...
	$resultado = mysqli_query($conexion, $query) or die("Error al crear productos");
	...
	$resultado = mysqli_query($conexion, $query) or die("Error al crear materiales");
	...
	$resultado = mysqli_query($conexion, $query) or die("Error al crear agenda");
	...
	$resultado = mysqli_query($conexion, $query) or die("Error al eventos");
	...
	$resultado = mysqli_query($conexion, $query) or die("Error al crear gastos");
	...
	$resultado = mysqli_query($conexion, $query) or die("Error al crear ventas");
?>
